...
class Tilawah extends CI_Controller 
{
     ...
     public function index()
    {
        ...
        return $this->load->view('sertifikat/tilawah/index', $data);
    }
    ...
    public function valueList()
    {
     ...
     $data = $this->sertificate->getEmployeesTilawah($postData);
...
// echo 'update';
        ...
        $data = $this->materi->db->where('id_program',3)->get('materi')->result();
            $this->load->view("sertifikat/tilawah/index", array(
                    'tilawah' =>$data,
                    // 'message' => $message
                ));
