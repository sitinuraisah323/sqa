...
class Tahsin extends CI_Controller 
{
     ...
     public function index()
    {
        ...
        return $this->load->view('sertifikat/tahsin/index', $data);
    }
    ...
    public function valueList()
    {
     ...
     $data = $this->sertificate->getEmployeesTahsin($postData);
