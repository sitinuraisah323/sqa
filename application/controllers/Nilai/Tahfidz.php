...
class Tahfidz extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        // }else{
            $this->load->view('nilai/tahfidz/index', $data );
        // }
    }
    ...
    // Get data
    $data = $this->task->getEmployees($postData);
// var_dump($data['data']); exit;
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
                ...
                $this->load->view("materi/tahfidz/index", array(
                    'tahfidz' =>$data,
                    'message' => $message
                ));
        ...
        if(! $_POST){
        $this->load->view("materi/tahfidz/add");
        }
  ...
  public function edit($id = null)
    {
        ...
        $this->load->view("materi/tahfidz/edit", $data);
    }
    ...
    public function delete($id)
    {
        ...
        if ($this->materi->delete($id)) {
            ...
            redirect(site_url('materi/tahfidz', ));
        }
    }
