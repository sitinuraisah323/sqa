...
class Tilawah extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        // }else{
            $this->load->view('nilai/tilawah/index', $data );
        // }
    }
    ...
    // Get data
    $data = $this->task->getEmployeesTilawah($postData);
// var_dump($data['data']); exit;
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
                ...
                $data = $this->materi->db->where('id_program',3)->get('materi')->result();
                $this->load->view("materi/tilawah/index", array(
                    'tilawah' =>$data,
                    'message' => $message
                ));
        ...
        if(! $_POST){
        $this->load->view("materi/tilawah/add");
        }
  ...
  public function edit($id = null)
    {
        ...
        $this->load->view("materi/tilawah/edit", $data);
    }
    ...
    public function delete($id)
    {
        ...
        if ($this->materi->delete($id)) {
            ...
            redirect(site_url('materi/tilawah', ));
        }
    }
