...
class DetailMateri extends CI_Controller 
{
    ...
    public function index($id)
    {
        ...
        $data['task'] = $this->task->db->where('id_materi',$id)->where('id_user',$this->session->userdata('id'))->get('task')->result();
    ...
    public function add($id)
    {
        ...
        if ($validation->run()) {
                ...
                $this->session->set_flashdata('success', 'Berhasil disimpan');
                 ...
                 $data['tahsin'] = $this->materi->db->where('id',$_POST['id_materi'])->get('materi')->result();
