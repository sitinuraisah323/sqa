...
<section class="news section">
    ...
    <div class="container">
        ...
        <div class="download-button text-right">
            <a href="<?php echo site_url('Sertifikat/Tahfidz/generate') ?> " class="btn btn-main-md"> Generate</a>
        </div>
        <div class="mt-30">
        <!-- Table -->
...
<script type="text/javascript">
	$(document).ready(function(){
	   	$('#empTable').DataTable({
	      	...
	      	'serverMethod': 'post',
	      	'ajax': {
	          'url':'<?=base_url()?>index.php/Sertifikat/Tahfidz/valueList'
	      	},
	      	'columns': [
	         	// { data: 'date' },
	         	{ data: 'nama' },
      ...
      return '<a href="<?php echo base_url('sertifikat/tahfidz/pdf')?>/'+data+'"><i class="fa fa-download"></i></a>';
    }
                },
	      	],
            'dom': 'Bfrtip',
