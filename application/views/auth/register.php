                    ...
                    <div class="registration-block bg-registration overlay-dark">
                        <div class="block" style="height: 500px; margin-top: 50px;">
                            <div class="title text-center">
                                <h3>Registration to <span class="alternate">SQAkhwat</span></h3>
                            ...
                            <form method="post" action="<?php echo base_url('auth/register'); ?>">
                                <div class="row col-md-4 mx-auto">
                                    ...
                                    <div class=" col-md-12">
                                        ...
                                        <input type="password" class="form-control  main"
                                            placeholder="Enter Confirm Password ..." id="password1" name="password1">
                                    </div>
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-white-md">Sign Up</button>
                                    </div>
                                    <br>
                                    <div class="col-12 title text-center">
                                        <br>
                                        <p>Sudah punya Akun ? <a href="<?php echo base_url('auth'); ?>">Login
                                                Now</a>
                                        </p>
                                    </div>
                            </form>
