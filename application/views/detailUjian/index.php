            ...
            <div class="col-lg-12 col-md-10 mx-auto">
                <div class="block">
                            ...
                            <div class="post-meta">
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        ...
                                        <a href="<?php echo base_url().'DetailUjian/download/'.$data->id ?>"><i
                                                class="fa fa-download"></i>Download Ujian</a>
                    ...
                    <div class="comment-form">
                        ...
                        <h5>Kirim Ujian</h5>
                        <form class="row" action="<?php echo site_url('DetailUjian/add/'.$data->id) ?>" method="post"
                    ...
                    <div class="comment-form">
                        ...
                        <p>
                                ...
                                <div class="img-block">
                                    ...
                                    if($extention == 'mp3' || $extention == 'wma'){
                                    ?>
                                    <audio src="<?php echo base_url().'DetailUjian/download1/'.$data->id ?>" controls
                                        preload="meta"> </audio>
                                    <?php } ?>
                                </div>
                                <?php } } }?>
