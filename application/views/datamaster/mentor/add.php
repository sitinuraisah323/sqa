...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo site_url('mentor/add') ?>" method="post" enctype="multipart/form-data">
            <div class="form-row">
                <div class="col-3">
                    <label for="nama">Nama*</label>
                    <input type="text" name="nama"
                        class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>" placeholder="Nama">
                    <input type="hidden" name="role_id" class="form-control" placeholder="namas" value="3">
