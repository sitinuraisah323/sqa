            ...
            <div class="col-12">
                ...
                <div class="card mb-3">
                    ...
                    <nav class="navbar card-header">
                        <a href="<?php echo site_url('peserta/add') ?>"><i class="fa fa-plus"></i> Add New</a>
                    
                         <form class="form-inline" method='post' action="<?php echo site_url('peserta') ?>" >
                            ...
                            <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url('peserta/edit/'.$data->id) ?>"
                                                class="btn btn-small"><i class="fa fa-edit"></i></a>
                                            <!-- <a onclick="deleteConfirm('<?php echo site_url('peserta/delete/'.$data->id) ?>')"
                                                href="#!" class="btn btn-small text-danger"><i class="fa fa-trash"></i>
                                            </a> -->
                                            <!-- <a href='<?php// echo base_url('peserta/delete/'.$data->id) ?>' class="btn btn-small text-danger delete_btn"><i class="fa fa-trash"></i></a> -->

                                            <!-- <button type="button" data-toggle="modal" data-id="<?php echo $data->id ?>" data-target="#modalHapus" class="btn btn-small text-danger"><i class="fa fa-trash"></i></button> -->
                                            <a href="<?php echo base_url('peserta/delete/'.$data->id)  ?>" id="a_id" class="btn btn-small text-danger">
