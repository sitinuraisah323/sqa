...
<div class="card mb-3">
    <div class="card-header">
        <a href="<?php echo site_url('ujian/tahfidz') ?>"><i class="fa fa-arrow-left"></i> Back</a>
    </div>
    <div class="card-body">

        <form action="<?php echo site_url('ujian/tahfidz/add') ?>" method="post" enctype="multipart/form-data">
            <div class="form-row">
                <div class="col-3">
                ...
                <div class="col-3">
					<label for="avatar">Upload Ujian</label>
