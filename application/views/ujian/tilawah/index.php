...
<?php endif; ?>
        <div class="download-button text-right">
             <?php if($this->session->userdata('role')!= 'Peserta'){ ?>   
                                <a href="<?php echo site_url('ujian/tilawah/add') ?> " class="btn btn-main-md"><i class="fa fa-plus "></i> Add
                                    New</a>
                                    <?php } ?>
                            </div>
        <div class="row mt-30">
                    ...
                    <div class="post-content">
                        ...
                        <div class="post-meta">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="<?php echo site_url('ujian/tilawah/edit/'.$data->id) ?>"
                                                class="btn btn-small"><i class="fa fa-edit"></i></a>
                                </li>
                                <li class="list-inline-item">
                                    <!-- <a onclick="deleteConfirm('<?php echo site_url('ujian/tilawah/delete/'.$data->id) ?>')"
                                                href="#!" class="btn btn-small text-danger"><i class="fa fa-trash"></i>
                                            </a> -->
                                            <a href="<?php echo base_url('ujian/tilawah/delete/'.$data->id)  ?>" id="a_id" class="btn btn-small text-danger">
...
<?php $this->load->view('ujian/tilawah/delete.php') ?>
